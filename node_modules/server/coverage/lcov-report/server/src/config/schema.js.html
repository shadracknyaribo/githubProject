...
56
57
58</td><td class="line-coverage quiet"><span class="cline-any cline-yes">14x</span>
...
<span class="cstat-no" title="statement not covered" >        value = option.arg.public || option.schema.default;</span>
<span class="cstat-no" title="statement not covered" >        console.log('LOG:', option.arg.public, option.schema.default);</span>
&nbsp;
