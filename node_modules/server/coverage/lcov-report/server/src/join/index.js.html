...
47
48
49</td><td class="line-coverage quiet"><span class="cline-any cline-yes">14x</span>
...
&nbsp;
  ...
  const fn = typeof ret === 'number' ? <span class="branch-0 cbranch-no" title="branch not covered" >'status' </span>: 'send';
